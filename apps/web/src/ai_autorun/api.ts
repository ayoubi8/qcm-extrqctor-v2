...
export function startAiAutoRunDraft(projectId: string, runId: string, draft: AiAutoRunDraft) {
...
export function controlAiAutoRunDraft(projectId: string, aiRunId: string, action: AiAutoRunAction) {
  return actionAiAutoRun(projectId, aiRunId, action, `ai-autorun:${aiRunId}:${action}`);
}